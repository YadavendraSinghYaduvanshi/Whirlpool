...
public class CommonString1 {
    ...
    public static final String KEY_WINDOWS_CD = "WINDOWS_CD";
    ...
    public static final String KEY_FIRST_0 = "0";
    public static final String KEY_FIRST_1 = "1";
    ...
    public static final String CREATE_TABLE_STOCK_DATA = "CREATE TABLE IF NOT EXISTS STOCK_DATA " +
            ...
            " BRAND VARCHAR,STORE_CD VARCHAR,STATE_CD VARCHAR,STORE_TYPE_CD VARCHAR,OPENING_TOTAL_STOCK VARCHAR," +
            " FACING VARCHAR,STOCK_UNDER_DAYS VARCHAR," +
            " EXPRIY_DATE VARCHAR)";
    ...
    public static final String TABLE_STORE_FIRST_TIME = "STORE_FIRST_TIME";
    public static final String CREATE_TABLE_STORE_FIRST_TIME = "CREATE TABLE IF NOT EXISTS STORE_FIRST_TIME" +
            "(Key_Id INTEGER PRIMARY KEY AUTOINCREMENT, STORE_CD VARCHAR, NAME VARCHAR, CONTACT VARCHAR, ADDRESS VARCHAR)";
    ...
    //public static final String URL = "http://tc.parinaam.in/tataservice.asmx";


    public static final String URL = "http://wp.parinaam.in/Whirlpoolservice.asmx";


    public static final String URL_Notice_Board = "http://wp.parinaam.in/notice/notice.html";
    ...
    public static final String KEY_FIRST_VISIT = "0";
    ...
    public static final String CREATE_TABLE_INSERT_POSM_DATA = "CREATE TABLE "
            + "INSERT_POSM_DATA"
            + " ("
            + KEY_ID
            + " INTEGER PRIMARY KEY AUTOINCREMENT ,"
...
///attendence data
    ...
    public static final String TABLE_INSERT_POSM_TRACKING_DATA = "posm_tracking_data";

    public static final String CREATE_TABLE_INSERT_POSM_TRACKING_DATA = "CREATE TABLE IF NOT EXISTS "
            + TABLE_INSERT_POSM_TRACKING_DATA
            + "("
            + "KEY_ID"
            + " INTEGER PRIMARY KEY AUTOINCREMENT ,"
    ...
    public static final String TABLE_DEPLOYMENT_FORM = "DEPLOYMENT_FORM";
    public static final String CREATE_TABLE_INSERT_DEPLOYMENT_FORM_DATA = "CREATE TABLE IF NOT EXISTS "
            + TABLE_DEPLOYMENT_FORM
            + "("
            + "KEY_ID"
            + " INTEGER PRIMARY KEY AUTOINCREMENT ,"
