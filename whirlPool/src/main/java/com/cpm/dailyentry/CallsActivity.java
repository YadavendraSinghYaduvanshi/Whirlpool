			...
			public void onClick(View arg0) {
				...
				try{
					...
					if(totalcalls.equals("") || productivecalls.equals("")){
						Toast.makeText(getApplicationContext(), CommonString1.PLS_FILL_DATA, Toast.LENGTH_SHORT).show();
					}
					else if(Integer.parseInt(totalcalls)<Integer.parseInt(productivecalls)){
						Toast.makeText(getApplicationContext(), CommonString1.CALLS_INVALID_DATA, Toast.LENGTH_SHORT).show();
