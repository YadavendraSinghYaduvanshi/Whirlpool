    ...
    private class AuthenticateTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                ...
                androidHttpTransport.call(CommonString1.SOAP_ACTION_LOGIN,
                        envelope);
                ...
                if (result.toString()
                    ...
                    if (failureGetterSetter.getStatus().equalsIgnoreCase(
                        ...
                        final AlertMessage message = new AlertMessage(
                                LoginActivity.this, CommonString1.METHOD_LOGIN
...
//				database.open();
                if (preferences.getString(CommonString1.KEY_VERSION, "").equals(
                    ...
                    intent.putExtra(CommonString1.KEY_PATH,
                            preferences.getString(CommonString1.KEY_PATH, ""));
                    startActivity(intent);
                    finish();
                }
    ...
    class AnswerTodayTask extends AsyncTask<AnswerData, Void, String> {
        ...
        protected String doInBackground(AnswerData... params) {
            ...
            try {
                ...
                androidHttpTransport.call(CommonString1.SOAP_ACTION + CommonString1.METHOD_UPLOAD_XML,
                        envelope);
